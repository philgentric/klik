...
FaceNet_embeddings_server.run_server(${PORT}, ${MONITOR_UDP_PORT})" &
done
...
MTCNN_face_detection_server.run_server(${PORT},${FACE_DETECTOR_ID}, ${MONITOR_UDP_PORT})" &
done
...
haars_face_detection_server.run_server(${PORT},${FACE_DETECTOR_ID}, ${MONITOR_UDP_PORT})" &
done
