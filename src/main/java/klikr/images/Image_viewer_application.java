...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        Image_window image_stage = Image_window.get_Image_window(path, new Path_list_provider_for_file_system(path.getParent(),stage,logger), Optional.empty(),stage,aborter,logger);
    }
}
