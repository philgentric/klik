...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        SwingUtilities.invokeLater(() -> {
                    ...
                    Path home = Paths.get(System.getProperty(Static_application_properties.USER_HOME));
    ...
    //**********************************************************
    {
        if ( properties_manager == null)
        {
            ...
            Path p = Paths.get(home, Static_application_properties.CONF_DIR, REGISTERED_APPLICATIONS_FILENAME);
