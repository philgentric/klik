...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        List<Old_and_new_Path> oanl = new ArrayList<>();
        oanl.add(oan);
        actual_safe_moves(owner, oanl, true,aborter,logger);
    }
    ...
    //**********************************************************
    {
        ...
        Runnable r = () -> actual_safe_moves(owner, the_list, and_list_for_undo, aborter, logger);
        try {
    ...
    //**********************************************************
    {
        ...
        for (Old_and_new_Path oanf : l) {
            Path trash_dir = Static_application_properties.get_trash_dir(oanf.old_Path,logger);
    ...
    //**********************************************************
    {
        ...
        for (Old_and_new_Path oandn : the_list) {
...

            {
                ...
                Path icon_cache_dir = Static_files_and_paths_utilities.get_icon_cache_dir(owner,logger);
    ...
    //**********************************************************
    {
        ...
        if (!Files.exists(oandn.get_new_Path().getParent()))
        {
            ...
            if (Static_application_properties.get_main_properties_manager(logger).remove_invalid_dir(path)) {
