...
//**********************************************************
public class New_file_browser_context
//**********************************************************
{
    ...
    //**********************************************************
    private New_file_browser_context(
            Path target,
    ...
    //**********************************************************
    {
        New_file_browser_context context = new New_file_browser_context(
                new_path,
                null,
                null,
                originator,
...
/*
    ...
    //**********************************************************
    {
        ...
        New_file_browser_context context = new New_file_browser_context(new_path, rectangle, null);
    ...
    //**********************************************************
    {
        ...
        New_file_browser_context context = new New_file_browser_context(new_path, rectangle, shutdown_target);
        new Image_playlist_browser(context, logger);
    }
    ...
    //**********************************************************
    {
        ...
        New_file_browser_context context = new New_file_browser_context(path, rectangle, null);
        new Image_playlist_browser(context, logger);
    }
