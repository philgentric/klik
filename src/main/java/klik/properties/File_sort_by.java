...
public enum File_sort_by {
  ...
  //**********************************************************
  {
    ...
    if (s == null)
    {
      Non_booleans.get_main_properties_manager().add_and_save(SORT_FILES_BY, File_sort_by.NAME.name());
  ...
  //**********************************************************
  {
    ...
    Non_booleans.get_main_properties_manager().add_and_save(SORT_FILES_BY, b.name());
  }
