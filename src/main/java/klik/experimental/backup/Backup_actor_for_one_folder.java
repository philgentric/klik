...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        if ( mini_console != null)
        {
            ...
            Old_and_new_Path oanp = new Old_and_new_Path(request.source_dir.toPath(), request.destination_dir.toPath(), Command.command_copy, Status_old_and_new_Path.copy_done,false);
            l.add(oanp);
