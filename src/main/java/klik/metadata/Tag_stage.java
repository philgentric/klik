...
//**********************************************************
{
    ...
    //**********************************************************
    public static void open_tag_edit_stage(Path path, Logger logger)
    //**********************************************************
    {
        open_tag_stage( path, true,  logger);
    }
    //**********************************************************
    public static void open_tag_view_stage(Path path, Logger logger)
    //**********************************************************
    {
        open_tag_stage( path, false,  logger);
    }

    //**********************************************************
    public static void open_tag_stage(Path path, boolean editable, Logger logger)
    //**********************************************************
    {
        ...
        Metadata_handler local_Metadata_handler = new Metadata_handler(path,logger);
        //if ( ultra_dbg)
        {
