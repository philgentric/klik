...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        Path tmp_dir = Non_zooleans.get_absolute_hidden_dir_on_user_home(Cache_folder.klik_image_feature_vectors_cache.name(), false,logger);
    ...
    //**********************************************************
    {
        ...
        for (Path p : path_list_provider.only_file_paths(Zooleans.get_boolean(Zooleans.SHOW_HIDDEN_FILES)))
        {
