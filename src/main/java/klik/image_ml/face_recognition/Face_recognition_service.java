...
//**********************************************************
{
    ...
    //**********************************************************
    private Face_recognition_service(String name_,
                                     //Browser browser,
    ...
    //**********************************************************
    {
        ...
        Browser_creation_context.additional_no_past(face_recognizer_path.toAbsolutePath().toString(),logger);
    ...
    //**********************************************************
    public static Face_recognition_service get_instance(
            //Browser browser,
            Window owner,Logger logger)
    //**********************************************************
    {
        if ( instance == null) start_new(
                //browser,
                owner,logger);
        return instance;
    }
    ...
    //**********************************************************
    {
        ...
        instance = new Face_recognition_service(localo.get(),
                //browser,
                owner,logger);
