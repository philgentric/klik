...
public class Feature_vector_mask
{
    ...
    public Feature_vector_mask(Feature_vector fv1, Feature_vector fv2, boolean not_same, Logger logger)
    {
    ...
    public Double similarity_with_mask_shorter(Feature_vector fv0, Feature_vector fv1)
    {
        int size = 0;
        ...
        Feature_vector fv0_masked = new Feature_vector(fv0_short);
        Feature_vector fv1_masked = new Feature_vector(fv1_short);
        return fv0_masked.cosine_similarity(fv1_masked);
    }

    public Double similarity_with_mask_stronger(Feature_vector fv0, Feature_vector fv1)
    {
