...
//**********************************************************
{
    ...
    record Face_recognition_results(String label, Image image,
                                    Path image_path,
                                    Feature_vector feature_vector, Face_recognition_status face_recognition_status)
    //**********************************************************
    {
    ...
    //**********************************************************
    {
        ...
        Path tmp_image_reco = Static_files_and_paths_utilities.get_icon_cache_dir(null,service.logger);
