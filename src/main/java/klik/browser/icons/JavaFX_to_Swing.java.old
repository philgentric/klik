...
changed the name of the class to make sure the errors would be explicit...

well maybe the problem is deeper:
 ...
 * @since JavaFX 2.2
 */
public class JavaFX_to_Swing
{
    private JavaFX_to_Swing() {} // no instances
     ...
     * @since JavaFX 2.2
     */
    public static BufferedImage fromFXImage(javafx.scene.image.Image img, BufferedImage bimg, Logger logger)
    {
