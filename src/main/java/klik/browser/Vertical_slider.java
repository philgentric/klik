...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        if ( dbg) logger.log("get_pixel_height, pixel_height="+pixel_height);
    ...
    //**********************************************************
    {
        ...
        {
            tmp = slider_value / get_slider_max(); // normalize (0,1)
        }
        ...
        if ( dbg) logger.log("slider_to_pixels tmp="+tmp);
    ...
    //**********************************************************
    {
        ...
        if ( dbg) logger.log("get_slider_max()="+get_slider_max());
