...
public class About_klik_stage
{
    ...
    //**********************************************************
    {
        ...
        l.add(new Line_for_info_stage(false,"    Klik \"Browser window\" has 4 top buttons that are always present (even if the folder is empty)"));
        ...
        l.add(new Line_for_info_stage(false,"        New Window button: will popup a new \"Browser\" Window"));
        ...
        l.add(new Line_for_info_stage(false,"     You can generate animated gifs icons for videos"));
