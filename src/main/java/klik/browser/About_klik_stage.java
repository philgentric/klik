...
public class About_klik_stage
{
    ...
    //**********************************************************
    {
        ...
        l.add(new Line_for_info_stage(false,"     Klik has 2 types of windows: \"Browser_old\" and \"Image\" "));
        l.add(new Line_for_info_stage(false,"     You can open has many windows as you want, the limit is your machine's RAM"));
        l.add(new Line_for_info_stage(true,"Browser_old Windows"));
        ...
        l.add(new Line_for_info_stage(false,"    Has a slideshow mode "));
        ...
        l.add(new Line_for_info_stage(false,"    Klik \"Browser_old window\" has 4 top buttons that are always present (even if the folder is empty)"));
        l.add(new Line_for_info_stage(false,"        Up button: will open the parent directory"));
        l.add(new Line_for_info_stage(false,"        Tools button: will popup a menu (see below)"));
        l.add(new Line_for_info_stage(false,"        New Window button: will popup a new \"Browser_old\" Window"));
        l.add(new Line_for_info_stage(false,"        Trash button: will display the content of the \"klik_trash\" folder"));
        ...
        l.add(new Line_for_info_stage(false,"        In a Browser_old window: "));
        ...
        l.add(new Line_for_info_stage(false,"           D&D works for buttons folders"));
        l.add(new Line_for_info_stage(false,"        In an Image window:  D&D enables to move the image"));
        l.add(new Line_for_info_stage(false,"        D&D reception spots (where you can drop something) include:"));
        l.add(new Line_for_info_stage(false,"          Browser_old window: the file will be moved into the corresponding folder"));
        ...
        l.add(new Line_for_info_stage(false,"     Klik history remembers the folders you visited, so you can shortcut"));
        l.add(new Line_for_info_stage(false,"     Klik history can be cleared (and it effectively erases forever the history...)"));
        ...
        l.add(new Line_for_info_stage(false,"     You can find images by keywords (it assumes keywords compose file names)"));
        ...
        l.add(new Line_for_info_stage(false,"     You can repair animated gifs"));
