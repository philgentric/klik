...
//**********************************************************
public class Virtual_landscape implements Scan_show_slave, Selection_reporter, Scroll_position_recorder
//**********************************************************
{
...
*/
    ...
    @Override
    public void record_scroll_position(Path path)
    {
    ...
    //**********************************************************
    {
        ...
        try
        {
            ...
            for ( Path path : path_list_provider.only_file_paths(show_hidden_files))
            {
                if (dbg) logger.log("Virtual_landscape: looking at path " + path.toAbsolutePath());
