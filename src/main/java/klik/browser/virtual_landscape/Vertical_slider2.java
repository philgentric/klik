...
//**********************************************************
public class Vertical_slider2 implements Landscape_height_listener, Scroll_to_listener2
//**********************************************************
{
    ...
    //**********************************************************
    public Vertical_slider2(
            Window stage,
            Pane pane_,
            Virtual_landscape2 virtual_landscape,
            Logger logger_)
    //**********************************************************
    {
    ...
    //**********************************************************
    private void slider_moved_by_user(double slider, Virtual_landscape2 virtual_landscape)
    //**********************************************************
    {
    ...
    public void perform_scroll_to(double y_offset_in_pixels, Virtual_landscape2 virtual_landscape)
    //**********************************************************
    {
        double pixel_height = get_pixel_height(virtual_landscape.get_virtual_landscape_height());
        if ( Virtual_landscape2.scroll_dbg) logger.log("y_offset_in_pixels = "+y_offset_in_pixels);
        if ( Virtual_landscape2.scroll_dbg) logger.log("pixel_height = "+pixel_height);

        double slider = pixels_to_slider(y_offset_in_pixels,pixel_height);
        if ( Virtual_landscape2.scroll_dbg) logger.log("scroll_absolute NEW slider value = "+slider);
