...
//**********************************************************
public class Feature_vector_bitmap implements Feature_vector
//**********************************************************
{
    ...
    //**********************************************************
    public Feature_vector_bitmap(String result, Logger logger)
    //**********************************************************
    {
        this.logger = logger;
    ...
    //**********************************************************
    {
        if ( feature_vector instanceof Feature_vector_bitmap other)
        {
    ...
    //**********************************************************
    {
        Feature_vector_bitmap other_feature_vector = (Feature_vector_bitmap) other_feature_vector_;
...
/*
    //**********************************************************
    private int hamming_distance(Feature_vector_bitmap other)
    //**********************************************************
    {
        BitSet xor = (BitSet) this.bitmap.clone();
        xor.xor(other.bitmap);
